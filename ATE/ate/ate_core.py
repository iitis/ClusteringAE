...
def experiment_simple(autoencoder_name,
                      dataset_name,
                      params_aa,
                      params_global,
    ...
    if model_path is not None:
        ...
        net = load_model(model_path,
                         get_autoencoder(autoencoder_name,
                                         params_aa,
                                         params_global))
    ...
    if mode == 'train':
        ...
        net = get_trained_network(autoencoder_name,
                                  data_loader,
                                  params_aa=params_aa,
    ...
    abundance_image, endmembers_spectra, _, _ = \
        unmix_autoencoder(net,
                          data_loader,
    ...
    evaluation_result, output_parameters = evaluate_autoencoder(
        ...
        image_shape=params_global['cube_shape'],
        rpath=params_global['path_results'],
        vpath=params_global['path_visualisations'],
        fname=filename)
    ...
    _, ratio_inside_simplex = investigate_simplex(
        X,
        endmembers_spectra,
        folder=path_for_saving_visualisation,
        filename=filename)
...
def experiment_tune(autoencoder_name,
                    dataset_name,
                    params_aa,
                    params_global,
                    tune_config,
