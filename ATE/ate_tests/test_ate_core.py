...
from ate.ate_core import (experiment_simple, _update_dataset_info,
                          _update_dataset_info)
from ate.ate_autoencoders import (get_autoencoder, get_trained_network,
                                  _aa_factory)
...
class Test(unittest.TestCase):
    ...
    def test_autoencoders(self):
        ...
        for autoencoder_name in self.aa_names:
            ...
            self.assertTrue(check_autoencoder(autoencoder_name,
...
def check_autoencoder(autoencoder_name,
                      params_global,
